...
export interface InventoryItem {
  year: string | Record<Language, string>;
...
export const inventoryData: InventoryCategory[] = [
  {
    ...
    items: [
      ...
      { year: "2010", title: { PT: "Campeonato Mundial de Beisebol Universitário - Intérprete oficial da seleção de Cuba", EN: "World University Baseball Championship - Official interpreter for the Cuban national team", JP: "世界大学野球選手権大会\nキューバ代表公式通訳" } },
      ...
      { year: "2019", title: { PT: "Rugby World Cup - Intérprete oficial nas sedes de Beppu, Kakegawa e Shin-Yokohama", EN: "Rugby World Cup - Official Interpreter for Beppu, Kakegawa and Shin-Yokohama venues.", JP: "ラグビーワールドカップ\n別府、掛川、新横浜会場公式通訳" } },
      { year: "2021", title: { PT: "Jogos Olímpicos e Paralímpicos de Tóquio - Intérprete oficial da sede de Basquetebol", EN: "Tokyo Olympic and Paralympic Games - Official interpreter for the Basketball venue", JP: "東京オリンピック・パラリンピック競技大会\nバスケットボール会場公式通訳" } }
    ]
  },
  {
    id: "artistica",
    ...
    items: [
      ...
      { year: "2017", title: { PT: "Kerry Ellis e Ben Foster (Broadway Solo Concert)", EN: "Kerry Ellis & Ben Foster (Broadway Solo Concert)", JP: "ケリー・エリス＆ベン・フォスター\n（ブロードウェイ・ソロ・コンサート）" } },
  ...
  },
  {
    ...
    items: [
      ...
      { year: "2019", title: { PT: "J.League Super Challenge (Chelsea vs Kawasaki Frontale) - Acompanhamento da visita de Marcel Desailly", EN: "J.League Super Challenge (Chelsea vs Kawasaki Frontale) - Accompanying Marcel Desailly's visit", JP: "Jリーグスーパーチャレンジ\n（チェルシー対川崎フロンターレ）\nマルセル・デサイー氏来日随行" }, url: "https://www.chelseafc.com/en/video/highlights--kawasaki-frontale--a--19-20-h1m3g2ate61dnjlf0vfqgavgc7zspecr" }
    ]
  },
  {
    id: "eventos",
