...
export const inventoryData: InventoryCategory[] = [
    {
        ...
        items: [
            ...
            { year: "1995-2016", title: { PT: "J-League (Verdy Kawasaki, Urawa Red Diamonds, Nagoya Grampus Eight, Tokyo Verdy, FC Gifu) - Intérprete de clubes profissionais", EN: "J-League (Verdy Kawasaki, Urawa Red Diamonds, Nagoya Grampus Eight, Tokyo Verdy, FC Gifu) - Pro Club Interpreter", JP: "Jリーグ（ヴェルディ川崎、浦和レッズ、名古屋グランパスエイト、東京ヴェルディ、FC岐阜）- プロクラブ通訳" } },
            { year: "2000", title: { PT: "Major League Baseball (MLB) - Primeiro jogo de abertura no Japão (Intérprete oficial)", EN: "Major League Baseball (MLB) - First opening game in Japan (Official Interpreter)", JP: "メジャーリーグベースボール（MLB）- 日本初の開幕戦（公式通訳）" } },
            ...
            { year: "2001-2016", title: { PT: "Kirin Challenge Cup (intérprete em todas as edições do evento)", EN: "Kirin Challenge Cup (interpreter for all editions of the event)", JP: "キリンチャレンジカップ（全大会通訳）" } },
    ...
    },
    {
        ...
        items: [
            ...
            { year: "2018", title: { PT: "La Cage aux Folles (Broadway)", EN: "La Cage aux Folles (Broadway)", JP: "ラ・カージュ・オ・フォール（ブロードウェイ）" } },
            { year: "2019", title: { PT: "Kinky Boots (Broadway)", EN: "Kinky Boots (Broadway)", JP: "キンキーブーツ（ブロードウェイ）" } }
        ]
    },
    {
        id: "governamental",
        ...
        items: [
            { year: "Anos diversos", title: { PT: "Departamento de Imigração de Tóquio - Intérprete", EN: "Tokyo Regional Immigration Bureau - Interpreter", JP: "東京出入国在留管理局 - 通訳" } },
    ...
    },
    {
        ...
        items: [
            ...
            { year: "2017", title: { PT: "FC Barcelona presents Rakuten in Japan - Intérprete da coletiva oficial de imprensa", EN: "FC Barcelona presents Rakuten in Japan - Official press conference interpreter", JP: "FCバルセロナ 楽天プレゼンツ・イン・ジャパン - 公式記者会見通訳" } },
